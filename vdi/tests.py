...
class UserExperienceTest(TestCase):
    def setUp(self):
        ...
        self.ue2 = UserExperience.objects.create(user=self.user1, application=self.app1, file_presented=datetime(2010,5,14,16,00), connection_closed=datetime(2010,5,14,17,45), access_date=datetime(2010,5,14,15,54))
        self.ue3 = UserExperience.objects.create(user=self.user1, application=self.app2, file_presented=datetime(2010,5,14,18,00), connection_closed=datetime(2010,5,14,18,45), access_date=datetime(2010,5,14,17,57))
        self.ue4 = UserExperience.objects.create(user=self.user2, application=self.app2, file_presented=datetime(2010,5,14,18,15), connection_closed=datetime(2010,5,14,18,40), access_date=datetime(2010,5,14,18,12))
